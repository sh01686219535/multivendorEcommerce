...
<div class="content-wrapper">
    <div class="container">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="row">
                <h3><i class="fas fa-sliders-h icon-i m-2"></i> Category</h3>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-head">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info ds-ib-block" data-bs-toggle="modal"
                                                        data-bs-target="#categoryUpdateModal{{$item->id}}"><i
                                                            class="fa fa-edit"></i></a>
                                                    <!-- Slider Update -->
                                                    <div class="modal fade" id="categoryUpdateModal{{$item->id}}" tabindex="-1"
                                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <x-form.form action="{{ route('admin.category.update',$item->id) }}"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h1 class="modal-title fs-5"
                                                                            id="exampleModalLabel">Category Update</h1>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <x-form.input type="text" name="name"
                                                                            placeholder="Enter Text" value="{{$item->name}}"/>
                                                    ...
                                                    <form class="ds-ib-block" id="delete-form-{{ $item->id }}" action="{{ route('admin.category.destroy', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
...
<div class="modal fade" id="sliderModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <x-form.form action="{{ route('admin.category.store') }}" method="post">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
